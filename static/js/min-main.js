...
function initAffixCheck() {
    ...
    e.affix({ offset: { top: 1 } }),
        windowT.width() < 1025 &&
            (windowT.off('.affix'),
            e.removeData('bs.affix').removeClass('affix affix-top affix-bottom'))
}
function initWow() {
...
;/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(
    ...
    $('body').imagesLoaded(function () {
        $('#spin-loader').fadeOut(), $('#loader-overflow').delay(200).fadeOut('slow')
    })
...
$(function () {
                            ...
                            (o = t[i]),
                                ...
                                n.push(
                                    function () {
                                        var t, n, s, r
                                        for (
                                            s = this.vendors, r = [], t = 0, n = s.length;
                                            n > t;
                                            t++
                                        )
                                            (a = s[t]),
    ...
    -1 != navigator.appVersion.indexOf('Win') &&
        !(function () {
            function e() {
                var e = !1
                e && c('keydown', o), b.keyboardSupport && !e && l('keydown', o)
            }
            function t() {
                if (document.body) {
                    var t = document.body,
            ...
            function i(e, t, i, n) {
                if ((n || (n = 1e3), d(t, i), 1 != b.accelerationMax)) {
                    ...
                    if (a < b.accelerationDelta) {
                        var s = (1 + 30 / a) / 2
                        s > 1 &&
                            ((s = Math.min(s, b.accelerationMax)), (t *= s), (i *= s))
                    }
                    M = +new Date()
                }
                if (
                    ...
                    var r = e === document.body,
                        l = function () {
                            ...
                            r
                                ? window.scrollBy(a, s)
                                : (a && (e.scrollLeft += a), s && (e.scrollTop += s)),
                                t || i || (D = []),
                                D.length ? N(l, e, n / b.frameRate + 1) : (E = !1)
                        }
                    N(l, e, 0), (E = !0)
                }
            }
            ...
            function r(e) {
                ...
                do {
                    ...
                    if ((t.push(e), i === e.scrollHeight)) {
                        if (!w || $.clientHeight + 10 < i) return s(t, document.body)
                    } else if (
            ...
            function f(e) {
                return e >= 1
                    ...
                    : 0 >= e
                    ? 0
                    : (1 == b.pulseNormalize && (b.pulseNormalize /= m(1)), m(e))
            }
            var v,
                g = {
                    frameRate: 150,
